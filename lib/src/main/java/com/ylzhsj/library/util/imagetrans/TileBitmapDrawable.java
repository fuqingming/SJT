...
public class TileBitmapDrawable extends Drawable {
    ...
    private static final class InitializationTask extends AsyncTask<Object, Void, Object> {
        ...
        protected Object doInBackground(Object... params) {
            ...
            final float minScale = Math.min(MyTransApplication.getScreenWidth() / (float) decoder.getWidth(), MyTransApplication.getScreenHeight() / (float) decoder.getHeight());
            ...
            try {
                ...
                if (null == bitmap) {
                    //下载的图片有问题,将其删掉
                    MyTransApplication.deleteFiles((String) params[0]);
