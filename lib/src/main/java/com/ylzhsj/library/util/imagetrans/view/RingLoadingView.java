package com.ylzhsj.library.util.imagetrans.view;
...
public class RingLoadingView extends View {
    private static final float DEFAULT_SIZE = MyTransApplication.dpToPx(48);
    private final Paint mPaint = new Paint();
    private float mStrokeWidth = MyTransApplication.dpToPx(1);
    ...
    private void init() {
        ...
        mProgressBounds.inset(MyTransApplication.dpToPx(6), MyTransApplication.dpToPx(6));
