...
import com.ylzhsj.sjt.adapter.ExtractHistoryAdapter;
import com.ylzhsj.sjt.adapter.MyWalletAdapter;

public class ExtractHistoryActivity extends BaseListActivity {

    private ExtractHistoryAdapter m_extractHistoryAdapter = new ExtractHistoryAdapter();
    ...
    protected void initData() {
        Utils.initCommonTitle(this,"提现历史",true);
    }

    @Override
    protected BaseRecyclerAdapter getListAdapter() {
        return m_extractHistoryAdapter;
    }
    ...
    protected void initLayoutManager() {
        ...
        mRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent it = new Intent(ExtractHistoryActivity.this,MyWalletDetailsActivity.class);
//                it.putExtra("webViewUrl",m_adapterNewsAnalysisAdapter.getListData().get(position).getDetail_url());
    ...
    protected void requestData(){
        ...
        executeOnLoadDataSuccess(DataUtil.initExtractHistory(),true);
        executeOnLoadFinish();
